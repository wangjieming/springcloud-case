...
##### 注：为什么需要应用名，这里简单说一下，因为服务提供者是一群服务，这一群服务共用一个应用名，然后把应用名注册到注册中心（zookeeper），服务消费者连到注册中心之后，就会知道某个应用名下有多少个服务，然后消费的时候，就会根据一定的负载均衡策略进行调用这群服务中的某一个，然后这一群服务提供者就可以共同承担消费者的流量了。
